...
class Stock extends React.Component {
    ...
    _renderButtons() {
        var viewButtonClass =
            this.props.stock.visibility === "on"
    ...
    _renderColorTab() {
        return this.props.stock.display ? (
            <div
                className="color-tab"
                style={{ backgroundColor: this.props.stock.color }}
            />
        ) : null;
    }
    ...
    render() {
        var netColor =
            this.props.stock.changePercent > 0 ? "#1BCEA2" : "#FF5722";
        return (
                ...
                <div className="stock-container" ref="stockContainer">
                    ...
                    <div className="stock-right">
                        ...
                        >
                            {"$ " +
                                helper
                                    .round(this.props.stock.price, 2)
                                    .toFixed(2)}
                        </div>
                        <div
                            className="stock-changePercent"
                            style={{ color: netColor }}
                        >
                            {helper.appendSign(
                                helper
                                    .round(
                                        this.props.stock.changePercent * 100,
                                        2
                                    )
                                    .toFixed(2)
                            ) + " %"}
